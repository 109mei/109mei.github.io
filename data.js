...
window.SITE_DATA = {
  ...
  /* ── 「数字で見る活動」の数字（§3-3）────────────────────────────
     ヒーローの stats と重複させない。すべて下のデータから数えられる値にする */
  statsDetail: [
    { label: '発表した研究会・大会', value: 5,  unit: '種類', note: 'ゲーム学会 全国大会1・研究部会4' },
    { label: '共同で発表した相手',   value: 5,  unit: '名',   note: '高校生・大学教員を含む' },
    { label: '学会発表のある年',     value: 3,  unit: '年',   note: '2024〜2026年' },
    { label: 'アーカイブした作品',   value: 34, unit: '本',   note: 'PLAYCEより。うち23本がブラウザで遊べる' }
  ],
